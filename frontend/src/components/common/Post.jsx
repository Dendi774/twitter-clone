...
const Post = ({ post }) => {
    ...
    const {mutate:deletePost, isPending:isDeleting, error, isError} = useMutation({
        mutationFn: async (postId) => {
            try{
                ...
                if (!res.ok) throw new Error(data.error || 'deleting post error');
                return data;
            }catch(err){
                throw new Error(err);
            }
    ...
    const {mutate: commentPost, isPending: isCommenting} = useMutation({
        ...
        onSuccess: () => {
            toast.success('commneted successfully');
            setComment("");
            queryClient.invalidateQueries({queryKey: ['posts']});
        },
        onError: (error) => {
